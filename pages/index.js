...
export default function Home({ posts, authorDetails }) {
  ...
  const { name, avatar, subtext } = frontMatter
  console.log(avatar)
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        <div className="pt-8 pb-10">
          <div className="flex flex-col items-center pt-8 space-x-2">
            ...
            <div className="text-gray-500 dark:text-gray-400 max-w-md">{subtext}</div>
          </div>
          {/* <div className="max-w-none xl:col-span-2">{subtext}</div> */}
        </div>
